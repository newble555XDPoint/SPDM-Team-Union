...
game:GetService("StarterGui"):SetCore("SendNotification", { 
	Title = "K00pgui (fe Version)";
	Text = "Team K00pkidd X SPDM Team Union fe";
	Icon = "rbxthumb://type=Asset&id=12854718934&w=150&h=150"})
Duration = 16;
	...
	function xds(dd)
		for i,v in next,dd:children''do
			if(v:IsA'BasePart')then
				...
				a.Color=Color3.new(212,0,0);
				a.Range=15;
				a.Brightness=5;
				f=Instance.new('Smoke',v);
				f.Size=19;
				f.Heat=22;
			end;
			game.Lighting.TimeOfDay=0;
			game.Lighting.Brightness=15;
			game.Lighting.ShadowColor=Color3.new(212,0,0);
...
s = Instance.new("Sky")
s.Name = "SKY"
s.SkyboxBk = "http://www.roblox.com/asset/?id=12864004378"
s.SkyboxDn = "http://www.roblox.com/asset/?id=12864004378"
s.SkyboxFt = "http://www.roblox.com/asset/?id=12864004378"
s.SkyboxLf = "http://www.roblox.com/asset/?id=12864004378"
s.SkyboxRt = "http://www.roblox.com/asset/?id=12864004378"
s.SkyboxUp = "http://www.roblox.com/asset/?id=12864004378"
s.Parent = game.Lighting
Spooky = Instance.new("Sound", game.Workspace)
Spooky.Name = "Spooky"
Spooky.SoundId = "rbxassetid://1846999567"
Spooky.Volume = 20
Spooky.Looped = true
Spooky:Play()
local ID =12864004378
...
EXPLOIT10.MouseButton1Down:connect(function()
	...
	s.Name = "Sound"
	s.SoundId = "http://www.roblox.com/asset/?id=1838974004"
	s.Volume = 5
	s.Pitch = 0.9
	s.Looped = true
	s.archivable = false
...
game.Players.LocalPlayer:Kick("Roblox has shut down.")
